...
async def dates_keyboard(dates: list) -> InlineKeyboardMarkup:
    ...
    for i, date in enumerate(dates):
        row.append(
            InlineKeyboardButton(text=date, callback_data=f"block_date_choose_{date}")
        )
...
async def create_keyboard_for_coaches(coaches: dict) -> InlineKeyboardMarkup:
    ...
    for i, (coach, coach_id) in enumerate(coaches.items()):
        row.append(
            InlineKeyboardButton(
                text=coach, callback_data=f"block_coach_choose_{coach_id}"
            )
        )
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                text="Return 🔙", callback_data="return_to_dates_of_blocking"
            ),
            InlineKeyboardButton(
...
async def create_keyboard_for_lessons(time: dict) -> InlineKeyboardMarkup:
    ...
    for i, (time_, lesson_id) in enumerate(time.items()):
        row.append(
            InlineKeyboardButton(
                text=time_, callback_data=f"block_lesson_choose__{time_}_{lesson_id}"
            )
        )
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                text="Return 🔙", callback_data="return_to_coaches_of_blocking"
            ),
            InlineKeyboardButton(
                text="Back to home 🏡", callback_data="back_to_main_menu"
            ),
