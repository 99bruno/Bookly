...
type_of_schedule_keyboard = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text="Create a template for all days ", callback_data="single_template")],
        [InlineKeyboardButton(text="Enter a template for each day", callback_data="multiple_templates")],
    ])


single_template_keyboard = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text="Start time", callback_data="single_event_start_time")],
        ...
        [InlineKeyboardButton(text="Return", callback_data="return_to_template_type"),
         InlineKeyboardButton(text="Confirm", callback_data="confirm_single_template")],
    ])
