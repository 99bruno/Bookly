...
from app.keyboards.camp_settings.camp_settings.edit_camp_info import *

from app.templates.camp_settings.camp_settings.edit_camp_info import *
...
from app.database.requests.view_full_schedule.edit_camp_info import *
