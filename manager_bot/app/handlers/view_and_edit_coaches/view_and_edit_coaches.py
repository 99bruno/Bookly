...
async def view_and_edit_coaches_handler(message: types.Message,
...
async def edit_coach_surname_handler(message: types.Message,
    ...
    try:
        ...
        await update_coach_info(coach_info["coaches_info"][coach_info["current_coach"]]["id"], "lastname",
                                coach_surname)
...
async def edit_coach_program_handler(callback_query: types.CallbackQuery,
    ...
    try:
        ...
        await callback_query.message.answer(
            coach_unpack_info(coach_info["coaches_info"][coach_info["current_coach"]], coach_info_message),
            reply_markup=coach_info_keyboard)
    ...
    try:
        ...
        if callback_query.data == "return_to_coach_info":
            ...
            await callback_query.message.edit_reply_markup(
                reply_markup=create_keyboard_for_dates(data["coaches_info"][data["current_coach"]]["dates"]))
            return
