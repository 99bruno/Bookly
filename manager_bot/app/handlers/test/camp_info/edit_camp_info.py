...
@router.message(F.text == "Camp info")
async def command_camp_info_handler(message: types.Message,
                                    bot: Bot,
    ...
    answer = await message.answer(camp_info_message, reply_markup=camp_info_keyboard)
...
async def command_edit_camp_info_handler(message: types.Message,
                                         bot: Bot,
                                         latest_messages: dict,
                                         state: FSMContext) -> None:
    await state.clear()
...
async def command_create_new_event_handler(message: types.Message,
    ...
    answer = await message.answer(change_name_message, reply_markup=types.ReplyKeyboardRemove())
...
async def command_add_event_name(message: types.Message,
    ...
    answer = await message.answer(await format_string(name, changed_name_message), reply_markup=change_name_keyboard)
...
async def command_create_new_event_handler(message: types.Message,
    ...
    answer = await message.answer(await format_string([data.description], change_description_massage), reply_markup=types.ReplyKeyboardRemove())
...
async def command_add_event_name(message: types.Message,
    ...
    answer = await message.answer(await format_string(description, changed_description_massage),
...
async def command_create_new_event_handler(message: types.Message,
    ...
    answer = await message.answer(change_date_massage, reply_markup=types.ReplyKeyboardRemove())
...
async def command_add_event_name(message: types.Message,
    ...
    answer = await message.answer("Oopppsss.. Now this function is not available currently 😕\n\n"
...
async def command_view_full_schedule_handler(message: types.Message,
    ...
    await message.answer_document(FSInputFile("schedule.xlsx"), caption=view_schedule_message,
