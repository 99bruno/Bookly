...
async def command_coaches_list_handler(message: types.Message,
    ...
    answer = await message.answer(coaches_unpack_info(coaches_info, coaches_list_message), reply_markup=coaches_list_keyboard(coaches_info))
...
async def callback_return_to_coaches_handler(callback_query: types.CallbackQuery,
    ...
    await callback_query.message.answer(edit_current_event_message, reply_markup=edit_current_event_keyboard)
