...
coach_added_message = ("Coach added! Check the information below:"
                       "\n\nName: {0}\nPrice: {1}\nProgram: {2}\nAvailable dates: {3}\n\nSchedule:\n{4}\n\n"
