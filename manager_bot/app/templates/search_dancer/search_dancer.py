dancers_info_message = (
    "Let’s search the information about any dancer you want! 💃🏼\n\n"
    "Enter the name and surname or phone number of the dancer 👇\n\n"
    "For example: 'Max Silo' or '380503271851'"
)

dancer_not_found_message = (
    "<b>Sorry, there is no such dancer found 😕</b>\n\n"
...
dancer_info_message = (
    "Here is the information about {0}\nPhone - +{1}\nTelegram - @{2}\n\n"
...
available_dates_message = (
    "The next step is choosing a coach 💫\n\n"
    "Choose a trainer from the list to view available hours 👇"
)


confirm_book_lessons_message = (
    "Good choice! 🌟\n\n"
    "Selected lessons:\n{0}\n\n"
    "Total price: {1}\n\n"
...
unavailable_lessons_message = (
    "Your classes have been successfully booked except for the following:\n\n{0} \n\n"
